...
**文件**: [episode_repository.go](internal/repository/episode_repository.go)
...
**文件**: [tag_repository.go](internal/repository/tag_repository.go)
...
**文件**: [tag_repository_test.go](internal/repository/tag_repository_test.go)
...
1. **[episode_repository.go](internal/repository/episode_repository.go)**
   - 添加 GetWithTags 方法
   - 代码行数: +10行

2. **[tag_repository.go](internal/repository/tag_repository.go)**
   - 添加 GetPodcastCountsBatch 方法
   - 代码行数: +45行

3. **[tag_relation_service.go](internal/services/tag_relation_service.go)**
   - 使用新的 Repository 方法
   - 消除直接数据库访问
   - 优化 N+1 查询
   - 代码行数: +15行, -10行 (净增5行，但性能提升显著)

4. **[tag_repository_test.go](internal/repository/tag_repository_test.go)**
   - 添加3个新测试
   - 代码行数: +82行
