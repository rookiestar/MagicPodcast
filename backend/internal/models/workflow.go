...
type JobExecution struct {
	...
	FeedSourceURL            string     `gorm:"size:1000;not null;default:''" json:"feed_source_url"`
	FeedIdentityVerification string     `gorm:"size:80;not null;default:not_checked" json:"feed_identity_verification"`
