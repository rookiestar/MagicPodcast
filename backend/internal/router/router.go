...
func SetupRouter(options ...Option) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.GET("/episodes/:id/people/drafts", personHandler.ReviewHistory)
		v1.POST("/episodes/:id/people/draft", personHandler.Review)
		v1.POST("/episodes/:id/people/apply", personHandler.ApplyReview)
		v1.POST("/episodes/:id/people/manual", personHandler.Manual)
