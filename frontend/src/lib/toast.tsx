...
function ToastContainer() {
  ...
  const getToastStyles = (type: ToastType) => {
    ...
    const typeStyles = {
      success: 'bg-green-50 text-green-800 border border-green-200 dark:bg-green-900/20 dark:text-green-200',
      error: 'bg-red-50 text-red-800 border border-red-200 dark:bg-red-900/20 dark:text-red-200',
      info: 'bg-blue-50 text-blue-800 border border-blue-200 dark:bg-blue-900/20 dark:text-blue-200',
      warning: 'bg-yellow-50 text-yellow-800 border border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-200',
    }
