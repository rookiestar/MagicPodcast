...
export const reportStatsSamples: Array<{
...
}> = [
  {
    ...
    stats: {
      ...
      tokens: 7245,
      tokens_status: "known",
      line: "3 个节目 · 3 集 · AI 已生成 · deepseek-flash · 7.2K Token",
    },
    content:
      "# 标题\n\n## 🤖 AI智能摘要\n\n短摘要\n\n---\n\n> **🕐 执行**: 2026-09-10 08:00:00 | **⏱️ 窗口**: 7天 (cron) | **📊 统计**: 3节目/3单集 | **🤖 AI**: 7.2K (deepseek-flash)\n\n> **📡 Feed覆盖**: 3/3 已尝试\n\n> 用户普通引用块\n\n单集详情",
  },
  {
    name: "not_generated",
    stats: {
      ...
      tokens: 7245,
      tokens_status: "known",
      line: "3 个节目 · 3 集 · AI 未生成 · deepseek-flash · 7.2K Token",
    },
    content: "# 标题\n\n> 用户普通引用块\n\n单集详情",
  },
  {
    ...
    stats: {
      ...
      tokens: 120,
      tokens_status: "known",
      line: "1 个节目 · 2 集 · AI 不完整 · deepseek-flash · 120 Token",
    },
    content: "# 标题\n\n半份结论\n",
  },
  {
  ...
  },
  {
    ...
    stats: {
      ...
      tokens: 12,
      tokens_status: "known",
      line: "3 个节目 · 3 集 · AI 已生成 · deepseek-flash · 12 Token",
    },
    content: `# 标题\n\n${"很长的摘要段落。".repeat(40)}\n\n> 用户普通引用块\n`,
  },
];
