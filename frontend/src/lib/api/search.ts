...
export const searchApi = {
  ...
  search: async (params: {
    ...
    if (params.episode_page) queryParams.append('episode_page', params.episode_page.toString())
    if (params.episode_page_size) queryParams.append('episode_page_size', params.episode_page_size.toString())
