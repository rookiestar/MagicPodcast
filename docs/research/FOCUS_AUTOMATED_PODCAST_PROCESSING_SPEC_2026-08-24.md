...
截至 2026-08-24，阶段 A 已合并到 `main`，但生产数据库尚未迁移。阶段 B 已在 #180 分支完成仓库实现、本地测试和 Mac mini 脱敏 Smoke；尚未合并、部署或接入生产 Worker。阶段 C–H 尚未实现。
...
- #180 合并后生产 Worker 的安装路径、启动配置、资源上限、日志轮转和重启恢复；
