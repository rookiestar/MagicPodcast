...
**4. [internal/handlers/error_response_test.go](../../../backend/internal/handlers/error_response_test.go)** (150+行)
...
**3. `internal/services/tag_service.go`** (350+行，历史文件，当前已删除)
...
**1. `src/hooks/useApi.ts`** (250+行，已在 2026-05-31 清理)
...
**3. `src/hooks/useSearch.ts`** (350+行，已在 2026-05-31 清理)
...
| 中间件 | error_response_test.go | 3 | ✅ 100%通过 |
