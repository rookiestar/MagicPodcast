...
| Inbox 完成历史验收 | [optimization/INBOX_COMPLETION_HISTORY_ACCEPTANCE_2026-08-23.md](optimization/INBOX_COMPLETION_HISTORY_ACCEPTANCE_2026-08-23.md) | #170 本地搜索、分页、失败保留、有效内容时间和多视口证据 |
...
- [Focus 自动化播客加工与单集助手 Spec](research/FOCUS_AUTOMATED_PODCAST_PROCESSING_SPEC_2026-08-24.md)：已确认 Mac mini 本地 Codex Runtime、飞书妙记加工、知识桥和只读单集助手边界；#179–#180、#185 与 #186 基础包已合并，#181 手动闭环已有真实 Smoke 修复待人工复核，#182 定时恢复与 #186 加工接线仍待合并；#186 仍须人工导入验收。
